...
3. Save the knowledge graphs to a CSV file.

The pipeline uses a Large Language Model (LLM) for various tasks including style analysis
and knowledge graph construction. It's designed to process long-form
...
and represent complex scientific content.
"""
...
# Function to construct knowledge graphs
def KG_construction(input_text, model, preprocessing_type="none"):
    """
    ...
    Returns:
    tuple: Contains the input text and constructed knowledge graph
    """
    ...
    return input_string_so_far, current_kg
...
for index, row in df.iterrows():
    ...
    # Perform KG construction
    input_string, kg_results = KG_construction(input_text, model_name)
