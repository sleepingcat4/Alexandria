...
def get_style_genre(input_text, model, system_prompt):
      ...
      for i in range(5):
        style_genre = scripts.llm.ask_Ollama (model, system_prompt, text , API_KEY ,temperature=0.5,top_p=0.95,max_tokens=1000, frequency_penalty=1.1,presence_penalty=1.1)
        try:
